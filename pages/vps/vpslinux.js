...
const vpsOptions = [
  {
    ...
    link: 'https://client.frozenhost.fr/store/basket/config/30',
    features: [
  ...
  },
  {
    ...
    link: 'https://client.frozenhost.fr/store/basket/config/31',
    features: [
  ...
  },
  {
    ...
    link: 'https://client.frozenhost.fr/store/basket/config/32',
    features: [
  ...
  },
  {
    ...
    link: 'https://client.frozenhost.fr/store/basket/config/33',
    features: [
  ...
  },
  {
    ...
    price: '29.99€',
    description: 'Une infrastructure pour vos besoins d’entreprise les plus exigeants.',
    link: 'https://client.frozenhost.fr/store/basket/config/34',
    features: [
...
const includedVpsFeatures = [
  { icon: <FaMicrochip />, title: 'Processeur', description: 'Equipez-vous de nos processeur Ryzen 7 3700X' },
    ...
    <div className="min-h-screen bg-gray-900 text-gray-200">
      ...
      >
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h1 className="text-4xl font-bold mb-2">VPS - Linux</h1>
      ...
      <div className="container mx-auto px-4 py-16 bg-gray-900">
        <h1 className="text-3xl font-bold mb-8 text-center">Nos Offres VPS Linux</h1>
