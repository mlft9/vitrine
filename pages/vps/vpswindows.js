...
const vpsOptions = [
  {
    ...
    link: 'https://client.frozenhost.fr/store/basket/config/6',
    features: [
  ...
  },
  {
    ...
    link: 'https://client.frozenhost.fr/store/basket/config/7',
    features: [
  ...
  },
  {
    ...
    link: 'https://client.frozenhost.fr/store/basket/config/8',
    features: [
  ...
  },
  {
    ...
    link: 'https://client.frozenhost.fr/store/basket/config/9',
    features: [
  ...
  },
  {
    ...
    price: '35.99€',
    description: 'Une infrastructure pour vos besoins d’entreprise les plus exigeants.',
    link: 'https://client.frozenhost.fr/store/basket/config/10',
    features: [
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 text-gray-200">
      ...
      >
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h1 className="text-4xl font-bold mb-2 text-white">VPS - Windows</h1>
          <p className="text-lg text-white">Solutions VPS performantes pour vos projets Cloud en toute sécurité.</p>
        </div>
      </motion.div>

      <div className="container mx-auto px-4 py-16">
        <h1 className="text-3xl font-bold mb-8 text-center text-cyan-300">Nos Offres <span className='text-white'>VPS Windows</span></h1>
