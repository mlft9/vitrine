...
const productOptions = [
  {
    ...
    link: 'https://client.frozenhost.fr/store/basket/config/47',
    features: [
  ...
  },
  {
    ...
    link: 'https://client.frozenhost.fr/store/basket/config/48',
    features: [
      { icon: <FaMicrochip />, text: '2 cœurs' },
  ...
  },
  {
    ...
    link: 'https://client.frozenhost.fr/store/basket/config/49',
    features: [
  ...
  },
  {
    ...
    link: 'https://client.frozenhost.fr/store/basket/config/50',
    features: [
