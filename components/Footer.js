    ...
    <footer className="bg-gray-900 text-white-300 p-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 mt-2">
            <li>
              <Link href="https://discord.gg/b4dgg75MmG" className="hover:text-white transition">
                &#x276F; Notre Discord
              </Link>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="space-y-2 mt-2">
            ...
            <li>
              <Link href="/conditions-vente" className="hover:text-white transition">
                &#x276F; Conditions de vente
              </Link>
            </li>
          </ul>
      ...
      <div className="mt-8 border-t border-gray-700 pt-4 flex flex-col md:flex-row items-center justify-between text-sm text-cyan-400">
        ...
        <p className="mt-4 md:mt-0">
          Site réalisé par <a href="https://www.twitch.tv/jenestreampasbeaucoup" target="_blank" rel="noopener noreferrer" className="text-cyan-800 hover:text-white">Matheo</a>
        </p>
      </div>
